...
namespace Dell.CloudIq.Api
{
    ...
    public partial class Hci : IHci
    {
        ...
        public Hci(System.Net.Http.HttpClient httpClient)
        {
        ...
        public virtual Task<HciSystem> SystemAsync(string select, string id, string x_identity_token)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async Task<HciSystem> SystemAsync(string select, string id, string x_identity_token, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/rest/v1/hci_systems/{id}?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<HciSystem>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/rest/v1/hci_systems?");
            if (filter != null)
            {
