...
# Write-Information is used throughout instead of Write-Host, so the output can be captured,
# redirected or suppressed by a caller. It is only shown when the preference asks for it.
