...
namespace Dell.CloudIq.Api
{
    ...
    public partial class Virtual : IVirtual
    {
        ...
        public Virtual(System.Net.Http.HttpClient httpClient)
        {
        ...
        public virtual Task<VirtualMachine> MachineAsync(string select, string id, string x_identity_token)
        {
            return MachineAsync(select, id, x_identity_token, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async Task<VirtualMachine> MachineAsync(string select, string id, string x_identity_token, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/rest/v1/virtual_machines/{id}?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<VirtualMachine>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual Task<CollectionResponse> MachinesAsync(string filter, string select, string order, int? limit, int? offset, string x_identity_token)
        {
            return MachinesAsync(filter, select, order, limit, offset, x_identity_token, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async Task<CollectionResponse> MachinesAsync(string filter, string select, string order, int? limit, int? offset, string x_identity_token, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/rest/v1/virtual_machines?");
            if (filter != null)
            {
