...
namespace Dell.CloudIq.Api
{
    ...
    public partial class Server : IServer
    {
        ...
        public Server(System.Net.Http.HttpClient httpClient)
        {
        ...
        public virtual Task<ServerSystem> SystemAsync(string select, string id, string x_identity_token)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async Task<ServerSystem> SystemAsync(string select, string id, string x_identity_token, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/rest/v1/server_systems/{id}?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ServerSystem>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/rest/v1/server_systems?");
            if (filter != null)
            {
