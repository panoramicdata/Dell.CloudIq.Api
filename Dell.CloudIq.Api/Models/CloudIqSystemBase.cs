...
/// <summary>
/// The properties every CloudIQ system reports, whatever kind of system it is: identity, location,
/// contact and the health scores CloudIQ keeps for each health category.
/// </summary>
public abstract class CloudIqSystemBase : CloudIqModel
{
	/// <summary>
