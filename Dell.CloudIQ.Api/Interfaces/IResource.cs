...
public interface IResource
{
	...
	Task<Srp> PoolAsync(string select, string id, string xIdentityToken);
	...
	/// <returns>OK</returns>
	/// <exception cref="ApiException">A server side error occurred.</exception>
	Task<Srp> PoolAsync(string select, string id, string xIdentityToken, CancellationToken cancellationToken);
	...
	/// <returns>OK</returns>
	/// <exception cref="ApiException">A server side error occurred.</exception>
	Task<CollectionResponse> PoolsAsync(string filter, string select, string order, int? limit, int? offset, string xIdentityToken);
