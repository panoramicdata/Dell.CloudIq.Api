...
public interface IStorage
{
	...
	Task<StorageGroup> GroupAsync(string select, string id, string xIdentityToken);
	...
	/// <returns>OK</returns>
	/// <exception cref="ApiException">A server side error occurred.</exception>
	Task<StorageGroup> GroupAsync(string select, string id, string xIdentityToken, CancellationToken cancellationToken);
	...
	/// <returns>OK</returns>
	/// <exception cref="ApiException">A server side error occurred.</exception>
	Task<CollectionResponse> GroupsAsync(string filter, string select, string order, int? limit, int? offset, string xIdentityToken);
	...
	/// <returns>OK</returns>
	/// <exception cref="ApiException">A server side error occurred.</exception>
	Task<CollectionResponse> GroupsAsync(string filter, string select, string order, int? limit, int? offset, string xIdentityToken, CancellationToken cancellationToken);
	...
	/// <returns>OK</returns>
	/// <exception cref="ApiException">A server side error occurred.</exception>
	Task<StorageSystem> SystemAsync(string select, string id, string xIdentityToken);
	...
	/// <returns>OK</returns>
	/// <exception cref="ApiException">A server side error occurred.</exception>
	Task<StorageSystem> SystemAsync(string select, string id, string xIdentityToken, CancellationToken cancellationToken);
	...
	/// <returns>OK</returns>
	/// <exception cref="ApiException">A server side error occurred.</exception>
	Task<CollectionResponse> SystemsAsync(string filter, string select, string order, int? limit, int? offset, string xIdentityToken);
