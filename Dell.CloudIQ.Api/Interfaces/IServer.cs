...
public interface IServer
{
	...
	Task<ServerSystem> SystemAsync(string select, string id, string xIdentityToken);
	...
	/// <returns>OK</returns>
	/// <exception cref="ApiException">A server side error occurred.</exception>
	Task<ServerSystem> SystemAsync(string select, string id, string xIdentityToken, CancellationToken cancellationToken);
