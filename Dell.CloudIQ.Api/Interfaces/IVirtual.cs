...
public interface IVirtual
{
	...
	Task<VirtualMachine> MachineAsync(string select, string id, string xIdentityToken);
	...
	/// <returns>OK</returns>
	/// <exception cref="ApiException">A server side error occurred.</exception>
	Task<VirtualMachine> MachineAsync(string select, string id, string xIdentityToken, CancellationToken cancellationToken);
	...
	/// <returns>OK</returns>
	/// <exception cref="ApiException">A server side error occurred.</exception>
	Task<CollectionResponse> MachinesAsync(string filter, string select, string order, int? limit, int? offset, string xIdentityToken);
	...
	/// <returns>OK</returns>
	/// <exception cref="ApiException">A server side error occurred.</exception>
	Task<CollectionResponse> MachinesAsync(string filter, string select, string order, int? limit, int? offset, string xIdentityToken, CancellationToken cancellationToken);
