...
public interface ICompute
{
	...
	Task<EsxiHost> HostAsync(string select, string id, string xIdentityToken);
	...
	/// <returns>OK</returns>
	/// <exception cref="ApiException">A server side error occurred.</exception>
	Task<EsxiHost> HostAsync(string select, string id, string xIdentityToken, CancellationToken cancellationToken);
	...
	/// <returns>OK</returns>
	/// <exception cref="ApiException">A server side error occurred.</exception>
	Task<CollectionResponse> HostsAsync(string filter, string select, string order, int? limit, int? offset, string xIdentityToken);
