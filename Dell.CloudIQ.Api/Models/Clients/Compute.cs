...
namespace Dell.CloudIq.Api
{
    ...
    public partial class Compute : ICompute
    {
        ...
        public Compute(System.Net.Http.HttpClient httpClient)
        {
        ...
        public virtual Task<EsxiHost> HostAsync(string select, string id, string x_identity_token)
        {
            return HostAsync(select, id, x_identity_token, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async Task<EsxiHost> HostAsync(string select, string id, string x_identity_token, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/rest/v1/compute_hosts/{id}?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<EsxiHost>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual Task<CollectionResponse> HostsAsync(string filter, string select, string order, int? limit, int? offset, string x_identity_token)
        {
            return HostsAsync(filter, select, order, limit, offset, x_identity_token, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async Task<CollectionResponse> HostsAsync(string filter, string select, string order, int? limit, int? offset, string x_identity_token, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/rest/v1/compute_hosts?");
            if (filter != null)
            {
