...
namespace Dell.CloudIq.Api
{
    ...
    public partial class Resource : IResource
    {
        ...
        public Resource(System.Net.Http.HttpClient httpClient)
        {
        ...
        public virtual Task<Srp> PoolAsync(string select, string id, string x_identity_token)
        {
            return PoolAsync(select, id, x_identity_token, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async Task<Srp> PoolAsync(string select, string id, string x_identity_token, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/rest/v1/storage_resource_pools/{id}?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<Srp>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual Task<CollectionResponse> PoolsAsync(string filter, string select, string order, int? limit, int? offset, string x_identity_token)
        {
            return PoolsAsync(filter, select, order, limit, offset, x_identity_token, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async Task<CollectionResponse> PoolsAsync(string filter, string select, string order, int? limit, int? offset, string x_identity_token, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/rest/v1/storage_resource_pools?");
            if (filter != null)
            {
