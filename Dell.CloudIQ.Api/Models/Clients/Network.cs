...
namespace Dell.CloudIq.Api
{
    ...
    public partial class Network : INetwork
    {
        ...
        public Network(System.Net.Http.HttpClient httpClient)
        {
        ...
        public virtual Task<NetworkSystem> SystemAsync(string select, string id, string x_identity_token)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async Task<NetworkSystem> SystemAsync(string select, string id, string x_identity_token, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/rest/v1/network_systems/{id}?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<NetworkSystem>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/rest/v1/network_systems?");
            if (filter != null)
            {
